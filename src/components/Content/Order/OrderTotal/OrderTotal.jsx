	...
	return (
		<div className="order__total">
			...
			<div className="order__total-info">
				...
				{
					extraData.color && extraData.extraCompleted
					? getTotalInfoItem({title: 'Цвет', result: extraData.color})
					: null
				}
				{
				...
				{
					extraData.rate && extraData.extraCompleted
					? getTotalInfoItem({title: 'Тариф', result: extraData.rate})
					: null
				}
				{
					extraData.fuel && extraData.extraCompleted
					? getTotalInfoItem({title: 'Топливо', result: 'Да'})
					: null
				}
				{
					extraData.babyChair && extraData.extraCompleted
					? getTotalInfoItem({title: 'Детское кресло', result: 'Да'})
					: null
				}
				{
					extraData.rightDrive && extraData.extraCompleted
					? getTotalInfoItem({title: 'Правый руль', result: 'Да'})
					: null
				}
			</div>
